...
class TestAddOmniFocusTask:
    ...
    async def test_add_task_to_inbox(self):
        ...
        with patch('omnifocus_mcp.mcp_tools.tasks.add_task.asyncio.create_subprocess_exec') as mock_exec:
            # Setup mock
    ...
    async def test_add_task_to_project(self):
        ...
        with patch('omnifocus_mcp.mcp_tools.tasks.add_task.asyncio.create_subprocess_exec') as mock_exec:
            # Setup mock
            mock_process = AsyncMock()
            mock_process.communicate.return_value = (b"Task added successfully to project: Work", b"")
            mock_process.returncode = 0
            mock_exec.return_value = mock_process
...
class TestEditItem:
    ...
    async def test_edit_task_name(self):
        ...
        with patch('omnifocus_mcp.mcp_tools.tasks.edit_item.asyncio.create_subprocess_exec') as mock_exec:
            # Setup mock
            mock_process = AsyncMock()
    ...
    async def test_edit_project(self):
        ...
        with patch('omnifocus_mcp.mcp_tools.tasks.edit_item.asyncio.create_subprocess_exec') as mock_exec:
            ...
            # Execute
            result = await edit_item(current_name="Old Project", new_name="New Project", item_type="project")
...
class TestRemoveItem:
    ...
    async def test_remove_task(self):
        ...
        with patch('omnifocus_mcp.mcp_tools.tasks.remove_item.asyncio.create_subprocess_exec') as mock_exec:
            # Setup mock
            mock_process = AsyncMock()
    ...
    async def test_remove_project(self):
        ...
        with patch('omnifocus_mcp.mcp_tools.tasks.remove_item.asyncio.create_subprocess_exec') as mock_exec:
            # Setup mock
            mock_process = AsyncMock()
            mock_process.communicate.return_value = (b"Project removed successfully: Test Project", b"")
            mock_process.returncode = 0
            mock_exec.return_value = mock_process
