...
class TestAddProject:
    ...
    async def test_add_project_basic(self):
        ...
        with patch('omnifocus_mcp.mcp_tools.projects.add_project.asyncio.create_subprocess_exec') as mock_exec:
            # Setup mock
            mock_process = AsyncMock()
            mock_process.communicate.return_value = (b"Project created successfully: Test Project", b"")
